  ...
  *************************/
  ...
  if(obj.styleTextLegend == 1){ //Procentagem + Etiqueta
    ...
    return result.length > 0 
      ? result[0].value.toFixed(serie.decimalPrecision) + " " + name 
        : zero.value.toFixed(serie.decimalPrecision) + " " + name;
    ...
    return name + " " + (result.length > 0 
      ? result[0].value.toFixed(serie.decimalPrecision) 
        : zero.value.toFixed(serie.decimalPrecision));
