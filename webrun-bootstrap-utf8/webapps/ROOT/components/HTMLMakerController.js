...
HTMLMakerController.prototype.editMode = function() {
  ...
  executeJSRule(this.sys, this.formID, ebfUtilReduceVariable('MK3-Ativar ediÃ§Ã£o', true), []);
  this.showInspector();
};
...
HTMLMakerController.prototype.saveToDatabase = function() {
  // Salva as alteraÃ§Ãµes no BD
  executeJSRule(this.sys, this.formID, ebfUtilReduceVariable('MK3-Salvar formulÃ¡rio', true), []);
};

HTMLMakerController.prototype.loadFromDatabase = function() {
  // Carrega as propriedade do formulÃ¡rio e dos componentes do banco de dados
...
HTMLMakerController.prototype.showInspector = function(component) {
  var FormInspetorID = executeSyncJavaRule(this.sys, this.formID, 'MK3-Obter cÃ³digo do formulÃ¡rio pelo GUID', "{8F8B4E5F-AD79-4611-BB45-7AF0B2226566}"); //6328;//ID do inspetor
...
/**
  Obtem uma propriedades do formulÃ¡rio
**/
...
/**
  Define uma propriedades do formulÃ¡rio
**/
...
HTMLMakerInfo.prototype.applyUpdates = function() {
  // Aplica as alteraÃ§Ãµes da propriedades ao componente
