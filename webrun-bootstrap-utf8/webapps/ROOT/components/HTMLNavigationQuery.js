...
HTMLNavigationQuery.prototype.setGridSizes = function() {
  ...
  // Definir variÃ¡vel de largura total.
  var totalWidth = 0;
  ...
  for (var i = 0; i < tableHeadThs.length; i++) {
    if (tableHeadThs[i].hasAttribute("data-field-index")) {
      ...
      // Obter a largura atual e a largura mÃ­nima.
      ...
      // Verificar se a largura nÃ£o estÃ¡ ultrapassando o limite.
