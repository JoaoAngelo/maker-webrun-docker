...
HTMLPaging.prototype.createButton = function(param, hint, icon) {
  ...
  // Associar eventos ao clique do botÃ£o.
  var object = this;
  ...
  // VariÃ¡vel utilizada em eventos.
  li.action = bt;

  // Criar Ã­cone do botÃ£o de paginaÃ§Ã£o.
...
HTMLPaging.prototype.design = function(grid) {
  ...
  // Cria div para alinhar os botÃµes no lado direito da grade.
  this.div = document.createElement("div");
  this.div.className = "d-flex h-100 justify-content-end align-middle"; // Bootstrap

  // Criar UL onde serÃ£o colocados os botÃµes.
  ...
  // Adiciona a barra de paginaÃ§Ã£o Ã  grade.
