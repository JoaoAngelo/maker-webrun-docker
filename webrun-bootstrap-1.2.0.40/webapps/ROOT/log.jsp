      ...
      <div class="col-sm-4 col-md-5 border-right">
        <form name="frm" method="post">
          ...
          <div class="btn-group btn-group-toggle w-100 border-bottom" data-toggle="buttons">
            <label class="btn btn-light rounded-0<% if (tipoLog.equals("1")) { %> active<% } %>">
              <input type="radio" name="tipoLog" value="1" id="rd2" autocomplete="off"<% if (tipoLog.equals("1")) { %> checked="checked"<% } %>> <webrun:message key="LABEL.RECORD_LOG"/>
            </label>
            <label class="btn btn-light rounded-0<% if (tipoLog.equals("2")) { %> active<% } %>">
