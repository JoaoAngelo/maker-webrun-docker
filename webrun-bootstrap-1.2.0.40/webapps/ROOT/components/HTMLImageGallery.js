...
HTMLImageGallery.prototype.updateList = function() {
  ...
  $.get(this.getRequestURL(),
    function(data) {
      ...
      // Se contém ";", quer dizer que tem mais de uma imagem.
      if (data.indexOf(";") != -1) {
        object.images = data.split(";"); // Obter IDs das imagens.
      } else object.images = [data]; // Única imagem, somente um ID.
...
HTMLImageGallery.prototype.deleteAction = function(e, o) {
  ...
  if (this.selectedImage != null) {
    ...
    interaction(getLocaleMessage("LABEL.GALLERY_DELETE_CONFIRM"), [], [function() {
      // OK
      $.get(object.selectedImage.serverUrl + "&type=d", function(response) {
        if (response != "1") interactionError(getLocaleMessage("LABEL.GALLERY_DELETE_ERROR"));
...
HTMLImageGallery.prototype.uploadAction = function(e, o) {
  ...
  this.unselectImage();
  openUpload(this.sys, this.formID, this.code, this.getCriptografado(), false, true);
};
