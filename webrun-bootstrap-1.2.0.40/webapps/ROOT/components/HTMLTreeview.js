function HTMLTreeview(sys, formID, code, posX, posY, width, height, value) {
  ...
  // muitas de suas variÃ¡veis sÃ£o utilizadas por
  // funÃ§Ãµes do Maker e para nÃ£o quebrÃ¡-las,
...
// Tamanho dos Ã­cones da Treeview
...
HTMLTreeview.prototype.clean = function() {
  ...
  // Limpa a variÃ¡vel de item selecionado
  this.selectedNode = null;

  // Limpa a variÃ¡vel de item com mouse em cima
...
HTMLTreeview.prototype.designComponent = function(doc) {
  ...
  this.nodesDiv.className = "list-group list-group-flush"; // Bootstrap
  this.div.appendChild(this.nodesDiv);

  // Definir variÃ¡vel para compatibilidade de funÃ§Ãµes.
...
/**
 * ObtÃ©m a referÃªncia para a Ã¡rvore.
 * FunÃ§Ã£o mantida para compatibilidade com a Ã¡rvore antiga.
 */
...
/**
 * ObtÃ©m o Ã­ndice de um filho pelo seu identificador.
 */
...
/**
 * ObtÃ©m o elemento que o mouse estÃ¡ em cima.
 */
...
/**
 * ObtÃ©m o elemento ativo nesta treeview.
 */
...
/**
 * FunÃ§Ã£o chamada toda vez que um elemento Ã© adicionado.
 */
...
/**
 * FunÃ§Ã£o chamada toda vez que um elemento Ã© removido.
 */
...
HTMLTreeview.prototype.addChild = function(parentElement, caption, link, target, isOpen) {
  ...
  // Se o elemento pai for a prÃ³pria Ã¡rvore, significa que Ã© pra ser adicionado na raiz.
  if (parentElement === this) {
    ...
    // Retorna a instÃ¢ncia do filho criado.
    return child;
  } else {
...
/**
 * Assocair fluxo ao evento de clique de um elemento da Ã¡rvore.
 * @param element ReferÃªncia para o elemento.
 * @param ruleName Nome do fluxo a ser chamado.
 * @param ruleParams ParÃ¢metros do fluxo.
 */
...
/**
 * Deleta todos os filhos de um nÃ³ da Ã¡rvore.
 * @param element ReferÃªncia do da Ã¡rvore para remover todos os seus filhos.
 */
