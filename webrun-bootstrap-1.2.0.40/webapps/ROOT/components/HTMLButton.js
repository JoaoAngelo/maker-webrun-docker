/**
 * MÃ©todo construtor do HTMLButton. ResponsÃ¡vel por criar o componente Button.
...
/**
 * Seta a descriÃ§Ã£o do componente button (objeto HTMLButton).
 * @param description - descriÃ§Ã£o do componente.
 **/
...
/**
 * Seta a cor da fonte da descriÃ§Ã£o do componente.
...
/**
 * Seta a fonte da descriÃ§Ã£o do componente.
 * @param f - fonte.
 **/
...
/**
 * Seta o tamanho da fonte da descriÃ§Ã£o do componente.
 * @param s - size.
 **/
 ...
 * @param v - TRUE indica que o componente Ã© somente leitura.
 **/
 ...
 * @param v - FALSE desabilita o botÃ£o.
 **/
...
HTMLButton.prototype.designComponent = function(doc) {
  ...
  // Define a descriÃ§Ã£o do componente.
  ...
  // Associar evento de clique ao botÃ£o.
  ...
  // Verifica se o botÃ£o possui um pai e se o mesmo Ã© o componente grade.
  // Caso as condicionais sejam verdadeiras, define que a tecla enter funcionarÃ¡ como tabulaÃ§Ã£o.
...
/**
 * Seta a propriedade Src da Imagem do botÃ£o.
 * @param img
 */
...
HTMLButton.prototype.setHint = function(hint) {
  let init = this.hint || this.button.hint ? false : true;
  if (this.button) {
