...
/**
 * Define os estados dos botÃµes de paginaÃ§Ã£o da barra de navegaÃ§Ã£o.
 * @param first Valor lÃ³gico indicando se o botÃ£o de primeira pÃ¡gina estÃ¡ habilitado.
 * @param previous Valor lÃ³gico indicando se o botÃ£o de pÃ¡gina anterior estÃ¡ habilitado.
 * @param next Valor lÃ³gico indicando se o botÃ£o de prÃ³xima pÃ¡gina estÃ¡ habilitado.
 * @param last Valor lÃ³gico indicando se o botÃ£o de Ãºltima pÃ¡gina estÃ¡ habilitado.
 **/
...
/**
 * Define o documento onde a navegaÃ§Ã£o serÃ¡ inicializada.
 * @param doc Documento onde a navegaÃ§Ã£o serÃ¡ inicializada.
 **/
HTMLNavigationQuery.prototype.setDocument = function(doc) {
  ...
  // Procurar pela div do rodapÃ©.
  this.searchFooter = this.doc.getElementById("search-footer");

  // Procurar pelo iframe de navegaÃ§Ã£o.
  this.navIframe = this.doc.getElementById("WFRQueryResults");

  // Procurar pelo spinner da pÃ¡gina.
  this.pageloader = this.doc.getElementById("pageloader");
};

/**
 * Define o Ã­ndice da primeira linha exibida na tabela.
 * @param firstRow Ã�ndice da primeira linha exibida na tabela.
 **/
...
/**
 * ObtÃ©m o Ã­ndice da primeira linha exibida na tabela.
 **/
...
/**
 * ObtÃ©m o total de registros da grade.
 **/
...
/**
 * Define os estados dos botÃµes de ordenaÃ§Ã£o da grade.
 **/
HTMLNavigationQuery.prototype.setOrderState = function() {
  this.gridOrdered = false;

  for (var i = 0; i < arguments.length; i++) {
    // Procurar pelo botÃ£o de ordenar da coluna.
...
/**
 * Define o valor lÃ³gico que indica se o filtro atual Ã© avanÃ§ado.
 * @param advancedQuery Valor lÃ³gico que indica se o filtro atual Ã© avanÃ§ado.
 **/
...
/**
 * ObtÃ©m um valor lÃ³gico que indica se o filtro atual Ã© avanÃ§ado.
 **/
...
/**
 * ResponsÃ¡vel por desenhar o HTML da navegaÃ§Ã£o.
 * @param doc Documento onde a navegaÃ§Ã£o serÃ¡ inicializada.
 **/
HTMLNavigationQuery.prototype.design = function(doc) {
  var object = this;

  // Associar eventos de tecla a pÃ¡gina.
  ...
  // Criar a barra de navegaÃ§Ã£o da grade da aba localizar.
  ...
  // Criar div de colapso da barra de navegaÃ§Ã£o.
  ...
  // Criar a navegaÃ§Ã£o da direita.
  ...
  // Criar item de primeira pÃ¡gina da navegaÃ§Ã£o da grade.
  ...
  // Criar item de pÃ¡gina anterior da navegaÃ§Ã£o da grade.
  ...
  // Criar item de prÃ³xima pÃ¡gina da navegaÃ§Ã£o da grade.
  ...
  // Criar item de Ãºltima pÃ¡gina da navegaÃ§Ã£o da grade.
  ...
  // Criar a navegaÃ§Ã£o da esquerda
  ...
  // Criar item de filtro avanÃ§ado
  this.designDivider();
  ...
  // Criar segundo Ã­cone para o item de pesquisa avanÃ§ada
  ...
  // Criar segundo Ã­cone para o item de limpar pesquisa
...
/**
 * Desenha um divisor na barra de navegaÃ§Ã£o.
 **/
...
/**
 * Desenha um item na barra de navegaÃ§Ã£o.
 * @param id ID do item.
 * @param action AÃ§Ã£o de clique do item.
 * @param enabled Valor lÃ³gico indicando se o item estÃ¡ ativado.
 * @param icon Classe do Ã­cone do item.
 * @param title TÃ­tulo do item.
 **/
HTMLNavigationQuery.prototype.designItem = function(id, action, enabled, icon, title) {
  // Criar LI do item na barra de navegaÃ§Ã£o.
  ...
  // Verificar se o item estÃ¡ ativado.
  if (enabled) {
    itemDiv.style.opacity = "1.0";
  } else {
    // Se o item nÃ£o estiver ativo, nÃ£o permitir nenhuma aÃ§Ã£o.
    itemDiv.className += " disabled";
    itemDiv.style.pointerEvents = "none";
    itemDiv.style.cursor = "default";
  }

  // Criar o link do item na barra de navegaÃ§Ã£o.
  ...
  // Verificar se o item possui tÃ­tulo.
  if (title) {
  ...
  // Verificar se o item possui Ã­cone.
  if (icon) {
    // Desenhar o Ã­cone do item.
    var itemIcon = this.doc.createElement("i");
    itemIcon.className = icon;
    itemLink.appendChild(itemIcon);
  }

  // Adicionar o item na barra de navegaÃ§Ã£o.
...
/**
 * Desenha um item dropdown na barra de navegaÃ§Ã£o.
 * @param id ID do item.
 * @param action AÃ§Ã£o de clique do item.
 * @param enabled Valor lÃ³gico indicando se o item estÃ¡ ativado.
 * @param icon Classe do Ã­cone do item.
...
HTMLNavigationQuery.prototype.designItemDropdown = function(id, action, enabled, icon, title) {
  // Desenhar o item na barra de navegaÃ§Ã£o.
  ...
  // Verificar se nÃ£o possui aÃ§Ã£o e possui tooltip.
  if (!action && title) {
...
/**
 * Desenha um tÃ­tulo num menu dropdown.
 * @param dropdown ReferÃªncia para o item que possui o menu dropdown.
 * @param title TÃ­tulo do item.
 **/
 ...
 * @param dropdown ReferÃªncia para o item que possui o menu dropdown.
 * @param index Ã�ndice da coluna na grade.
 * @param field ID da coluna da grade.
 * @param fieldName Nome da coluna da grade.
 * @param fieldVisible Valor lÃ³gico indicando se a coluna estÃ¡ visÃ­vel.
...
HTMLNavigationQuery.prototype.assignGridField = function(dropdown, index, field, fieldName, fieldVisible, fieldSize, fieldRealName) {
  ...
  if (dropdown) {
    ...
    dropdownItem.onclick = function(e) {
      ...
      // Verificar se a checkbox nÃ£o estÃ¡ desabilitada.
      if (!dropdownItemCheckboxInput.disabled) {
        ...
        // Salvar preferÃªncias do usuÃ¡rio no servidor.
...
/**
 * Finaliza a criaÃ§Ã£o do menu dropdown da grade.
 * @param dropdown ReferÃªncia para o item que possui o menu dropdown.
 * @param defaultItem DescriÃ§Ã£o para o item de voltar ao padrÃ£o.
 **/
HTMLNavigationQuery.prototype.finishDropdownDesign = function(dropdown, defaultItem) {
  if (dropdown && defaultItem) {
    ...
    // Desenhar o item de voltar ao padrÃ£o no menu dropdown.
...
/**
 * Salva as customizaÃ§Ãµes da grade (tamanho e visibilidade das colunas) do usuÃ¡rio atual.
 **/
HTMLNavigationQuery.prototype.saveCustomizations = function(reload) {
  ...
  // Obter os itens do primeiro <tr> do cabeÃ§alho da grade.
  ...
  for (var i = 0; i < tableHeadThs.length; i++) {
    if (tableHeadThs[i].hasAttribute("data-scope-index")) {
      // Obter o Ã­ndice da coluna no escopo da pÃ¡gina.
      var index = parseInt(tableHeadThs[i].getAttribute("data-scope-index"));

      // Definir Ã­ndices mÃ­nimos e mÃ¡ximos.
      minIndex = Math.min(minIndex, index);
      maxIndex = Math.max(maxIndex, index);

      // Verificar se os Ã­ndices estÃ£o diferentes.
      if (index != i) {
        // Ã�ndices nÃ£o batem, isso significa que as colunas da tabela foram reordenadas.
        hasReordered = true;
      }
    }
  }
  ...
  if (hasReordered) {
    // Montar o JSON da requisiÃ§Ã£o usando a ordem definida.
    for (var i = 0; i < tableHeadThs.length; i++) {
    ...
    for (var i = 0; i < this.gridHeaderFields.length; i++) {
      // Verificar se o Ã­ndice atual estÃ¡ fora do escopo.
    ...
    // Montar o JSON da requisiÃ§Ã£o usando as colunas jÃ¡ definidas.
    for (var i = 0; i < this.gridHeaderFields.length; i++) {
      requestJson.push({
        "field": this.gridHeaderFields[i].field,
        "show": this.gridHeaderFields[i].fieldVisible ? "1" : "0",
  ...
  if (requestJson.length > 0) {
    // Mandar requisiÃ§Ã£o para o servidor para atualizar as customizaÃ§Ãµes do usuÃ¡rio.
 ...
 * @param gridini Ã�ndice do primeiro item exibido na grade.
 * @param gridrn Ã�ndice do Ã­tem do registro.
 **/
HTMLNavigationQuery.prototype.navigateToRegistry = function(gridini, gridrn) {
  var gt = 1 + parseInt(gridrn) + parseInt(gridini);
  mainform.getAndEval('form.do?sys=' + mainform.sysCode + '&action=form&param=goto&formID=' + mainform.idForm + '&align=-1&mode=&goto=' + gt + '&filter=');
  mainform.document.n.normal();
  mainform.document.t.tabs[0].select(); // Seleciona a aba
};

/**
 * Navega atravÃ©s das pÃ¡ginas da grade.
 * @param action Nome da action que irÃ¡ lidar com a navegaÃ§Ã£o da grade.
 * @param param Tipo da navegaÃ§Ã£o (prÃ³xima pÃ¡gina, pÃ¡gina anterior, etc).
 **/
...
HTMLNavigationQuery.prototype.addGridRow = function(values) {
  ...
  for (var i = 0; i < values.length; i++) {
    ...
    rowTd.innerHTML = values[i] == "&nbsp;" ? "&nbsp;" : stringToHTMLString(values[i]);
...
HTMLNavigationQuery.prototype.updateLayout = function() {
  // Atualizar botÃ£o de primeira pÃ¡gina da barra de navegaÃ§Ã£o.
  ...
  // Atualizar botÃ£o de pÃ¡gina anterior da barra de navegaÃ§Ã£o.
  ...
  // Atualizar botÃ£o de prÃ³xima pÃ¡gina da barra de navegaÃ§Ã£o.
  if (this.navItemNext) {
    if (this.next) {
  ...
  // Atualizar botÃ£o de Ãºltima pÃ¡gina da barra de navegaÃ§Ã£o.
  if (this.navItemLast) {
    if (this.last) {
  ...
  // Verificar se nÃ£o Ã© Internet Explorer.
  ...
  if (gridFieldVisibilityItem) {
    ...
    for (var i = 0; i < checkboxes.length; i++) {
      // Verificar se a grade possui uma coluna visÃ­vel.
      if (this.gridVisibleFieldsLength <= 1) {
        // Desabilitar a checkbox para nÃ£o permitir que a grade seja oculta por completo.
        checkboxes[i].disabled = checkboxes[i].checked;
      } else {
        // NÃ£o desabilitar a checkbox.
        checkboxes[i].disabled = false;
      }
    }
  }

  // Obter item de remover ordenaÃ§Ã£o da grade.
  ...
  if (gridRemOrderItem) {
    ...
    // Obter o nav-link do item de remover ordenaÃ§Ã£o da grade.
    ...
    if (gridRemOrderItemLink.length > 0) {
      ...
      // Verificar se o segundo Ã­cone ainda nÃ£o foi criado.
      var gridRemOrderItemIcons = gridRemOrderItemLink[0].getElementsByTagName("i");
      if (gridRemOrderItemIcons.length <= 1) {
        // Criar segundo Ã­cone para o item de remover ordenaÃ§Ã£o da grade.
  ...
  // Verificar se estÃ¡ em filtro avanÃ§ado.
  ...
  for (var i = 0; i < jcolResizers.length; i++) {
    // Atualizar o tamanho deles pois as vezes eles mantÃªm a altura anterior.
...
HTMLNavigationQuery.prototype.updateFieldsLayout = function() {
  ...
  if (isEmpty && this.gridHead) {
    ...
    if (gridInputs.length > 0) {
      for (var i = 0; i < gridInputs.length; i++) {
        // Verificar se o campo nÃ£o estÃ¡ vazio.
  ...
  if (!isEmpty && this.searchValue != this.lastSearchValue) {
    // Exibir rodapÃ© da aba localizar.
    $(this.searchFooter).collapse("show");
  } else {
    // Esconder rodapÃ© da aba localizar.
    $(this.searchFooter).collapse("hide");
  }
};

/**
 * Finaliza a inicializaÃ§Ã£o da navegaÃ§Ã£o da aba localizar.
 **/
HTMLNavigationQuery.prototype.finishDesign = function() {
  ...
  for (var i = 0; i < filterTypeDropdowns.length; i++) {
    ...
    for (var j = 0; j < dropdownItems.length; j++) {
      (function(context, index, dropdownMenu, dropdownItem) {
        ...
        dropdownItem.onclick = function(e) {
          // Procurar pelo input onde Ã© armazenado o valor atual.
  ...
  // Marcar a navegaÃ§Ã£o como inicializada.
  this.initialized = true;
};

/**
 * Retorna um valor lÃ³gico indicando se a navegaÃ§Ã£o foi inicializada.
 **/
 ...
 * @param row ReferÃªncia para o elemento da linha da grade.
 **/
HTMLNavigationQuery.prototype.selectGridRow = function(row) {
  ...
  // Adicionar classe highlight na linha, se nÃ£o tiver.
 ...
 * @param el ReferÃªncia para o elemento da linha da grade.
 **/
 ...
 * @param background Valor lÃ³gico indicando se o preloader deve ter cor de fundo.
 **/
...
/**
 * Ocorre quando o pedido Ã© finalizado.
 **/
HTMLNavigationQuery.prototype.onRequestFinished = function() {
  ...
  // Tornar a grade reodernÃ¡vel e redimensionÃ¡vel.
...
/**
 * Inicializa o Drag & Drop Table Columns na grade para fazer ela reordenÃ¡vel.
 **/
HTMLNavigationQuery.prototype.makeGridDraggable = function() {
  ...
  $(this.grid).dragableColumns({
    ...
    onDragEnd: function(colPositions) {
      // Salvar customizaÃ§Ãµes do usuÃ¡rio.
      object.saveCustomizations(true);
    }
  });
...
/**
 * Inicializa o colResizable na grade para fazer ela redimensionÃ¡vel.
 **/
...
/**
 * Envia um pedido ao servidor e atualiza a grade apÃ³s a finalizaÃ§Ã£o.
 * @param field ReferÃªncia para o elemento da coluna da grade.
 **/
...
HTMLNavigationQuery.prototype.setGridSizes = function() {
  // Obter os itens do cabeÃ§alho da grade.
  var firstHead = this.grid.getElementsByTagName("thead")[0];
  var firstHeadTr = firstHead.getElementsByTagName("tr")[0];
  var tableHeadThs = firstHeadTr.getElementsByTagName("th");
  ...
  for (var i = 0; i < tableHeadThs.length; i++) {
    if (tableHeadThs[i].hasAttribute("data-field-index")) {
      var index = parseInt(tableHeadThs[i].getAttribute("data-field-index"));
      this.gridHeaderFields[index].fieldSize = parseInt(window.getComputedStyle(tableHeadThs[i]).width);
    }
  }
};

/**
 * Remove a ordenaÃ§Ã£o da grade.
 **/
...
/**
 * Abre a tela de importaÃ§Ã£o de dados.
 **/
...
/**
 * Tratar as teclas de atalho da pÃ¡gina.
 **/
HTMLNavigationQuery.prototype.handleShortcutKeys = function(e) {
  ...
  if (e.target.tagName.toUpperCase() == "INPUT") {
    ...
    // Obter o Ã­ndice do input atual.
    for (var i = 0; i < gridInputs.length; i++) {
    ...
    if (highlightedRow) {
      // Procurar pelo Ã­ndice da linha selecionada.
    ...
    if (e.which === 38 || e.code === "ArrowUp") {
      ...
      if (highlightedRow) {
        if (rowIndex - 1 < 0) {
          // Selecionar a Ãºltima linha da grade.
      ...
      if (highlightedRow) {
        if (rowIndex + 1 < gridTrs.length) {
          // Selecionar a prÃ³xima linha da grade.
          targetRow = gridTrs[rowIndex + 1];
          rowIndex++;
        } else {
      ...
      // Clicar no item de pÃ¡gina anterior.
      ...
      // Clicar no item de prÃ³xima pÃ¡gina.
      ...
      // Realizar aÃ§Ã£o de duplo clique na linha da grade.
    ...
    if (targetRow) {
      ...
      // Rolar a grade para a linha selecionada, se necessÃ¡rio.
