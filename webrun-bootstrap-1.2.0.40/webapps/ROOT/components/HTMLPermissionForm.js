...
/**
 * Desenhar o editor de permissÃµes do formulÃ¡rio.
 */
HTMLPermissionForm.prototype.design = function() {
  // Obter a div lay do formulÃ¡rio.
  this.doc = d && d.lay ? d.lay : document.getElementById("lay");

  // Criar a div base do edito de permissÃµes.
  ...
  // Verificar se a lista de formulÃ¡rios foi definida.
  if (this.forms && this.forms.length > 0) {
    // Criar o select da lista de formulÃ¡rios.
    ...
    // Criar opÃ§Ãµes dos formulÃ¡rios.
    ...
    // Criar botÃ£o de abrir formulÃ¡rio.
    ...
    // Associar evento de clique ao botÃ£o de abrir formulÃ¡rio.
    ...
    // Associar evento de alterar no select de formulÃ¡rios.
  ...
  // Criar botÃ£o de editar permissÃµes do formulÃ¡rio.
  ...
  // Associar evento de clique ao botÃ£o de editar permissÃµes do formulÃ¡rio.
