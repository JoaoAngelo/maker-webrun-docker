...
HTMLNavigationForm.prototype.execAjaxEval = function(param) {
  ...
  if (param == "refreshAllEdit" && paramsValue != null && paramsValue.length != 0) {
    url = 'form.do?sys=' + this.sys + '&formID=' + this.formID + '&param=edit&align=0&filter=' + paramsValue + '&goto=' + formrow;
  } else if (param == "refreshAllInclude" && paramsValue != null && paramsValue.length != 0) {
    url = 'form.do?sys=' + this.sys + '&formID=' + this.formID + '&param=include&align=0&filter=' + paramsValue + '&goto=' + formrow;
  } else if (param == "refreshAllShow" && paramsValue != null && paramsValue.length != 0) {
    url = 'form.do?sys=' + this.sys + '&formID=' + this.formID + '&param=refreshAll&align=0&filter=' + paramsValue + '&goto=' + formrow;
  } else if (param === "refresh" && typeof paramsValue === "string") {
    url = 'form.do?sys=' + this.sys + '&formID=' + this.formID + '&param=' + param + '&filter=' + paramsValue + '&align=0&filter=&goto=' + formrow;
  } else {
    url = 'form.do?sys=' + this.sys + '&formID=' + this.formID + '&param=' + param + '&align=0&filter=&goto=' + formrow;
  }
      ...
      function(boolTest, sys, formID) {
        try {
          ...
          **/
          ...
          WFRFormComands.location = 'form.do?sys=' + sys + '&formID=' + formID + '&action=form&param=delete&filter=&pType=1&goto=' + formrow;
